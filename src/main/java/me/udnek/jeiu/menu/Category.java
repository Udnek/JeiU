...
public abstract class Category extends AbstractRegistrable {
    ...
    public static final Category ALL_ITEMS = register(new Category("all_items", Component.translatable("item.jeiu.custom_items")) {
        @Override
        public ItemStack getItemIcon(AllItemsMenu context) {
        ...
        @Override
        public Component getTextIcon() {
            return Component.text("0").font(Key.key("jeiu:category"));
        }

        @Override
        public List<ItemStack> getAll(AllItemsMenu context) {
    ...
    public static final Category CUSTOM_RECIPES = register(new Category("custom_recipes", Component.translatable("item.jeiu.custom_recipes")) {
        ...
        @Override
        public Component getTextIcon() {
            return Component.text("1").font(Key.key("jeiu:category"));
        }
    ...
    public static final Category ENCHANTED_BOOKS = register(new Category("enchanted_books", Component.translatable("item.jeiu.enchanted_books")) {
        ...
        @Override
        public Component getTextIcon() {
            return Component.text("2").font(Key.key("jeiu:category"));
        }
    ...
    public static final Category STRUCTURES = register(new Category("structures", Component.translatable("item.jeiu.structures")) {
        ...
        @Override
        public Component getTextIcon() {
            return Component.text("3").font(Key.key("jeiu:category"));
        }
    ...
    private static Category register(Category category){
    ...
    public Category(String rawId, Component categoryName) {
        this.rawId = rawId;
    ...
    public Component getCategoryName() {
        return getTextIcon().append(categoryName.font(NamespacedKey.minecraft("default")));
    }

    public abstract ItemStack getItemIcon(AllItemsMenu context);
    public abstract Component getTextIcon();
    public abstract List<ItemStack> getAll(AllItemsMenu context);
}
