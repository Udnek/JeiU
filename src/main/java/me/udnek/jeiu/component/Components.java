...
public class Components {
    ...
    public static final ConstructableComponentType<CustomRecipe<?>, VisualizableRecipe> VISUALIZABLE_RECIPE;
    ...
    static {
        VISUALIZABLE_RECIPE = register(new ConstructableComponentType<>("visualizable_recipe", VisualizableRecipe.EMPTY));
